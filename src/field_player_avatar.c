...
static const u8 sPlayerAvatarGfxIds[COSTUME_COUNT][PLAYER_AVATAR_STATE_COUNT][GENDER_COUNT] =
{
    ...
    [COSTUME_1] =
    {
        ...
        {OBJ_EVENT_GFX_MAY_MACH_BIKE,   OBJ_EVENT_GFX_BRENDAN_MACH_BIKE},
        {OBJ_EVENT_GFX_MAY_ACRO_BIKE,   OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE},
        {OBJ_EVENT_GFX_MAY_SURFING,     OBJ_EVENT_GFX_BRENDAN_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,  OBJ_EVENT_GFX_BRENDAN_UNDERWATER},
        {OBJ_EVENT_GFX_MAY_FIELD_MOVE,  OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE},
        {OBJ_EVENT_GFX_MAY_FISHING,     OBJ_EVENT_GFX_BRENDAN_FISHING},
        {OBJ_EVENT_GFX_MAY_WATERING,    OBJ_EVENT_GFX_BRENDAN_WATERING},
    },
};
